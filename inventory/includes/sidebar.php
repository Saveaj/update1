...
.bg-side {
  ...
  <title>Arenas Rice Trading</title>
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-side sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
        ...
        <div class="sidebar-brand-text mx-3">Arenas Rice Trading</div>
      </a>
      ...
      <li class="nav-item">
        <a class="nav-link" href="stocklogs.php">
          <i class="fas fa-fw fa-retweet"></i>
          <span>Stock Logs</span></a>
      </li>
